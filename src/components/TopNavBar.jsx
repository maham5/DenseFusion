...
const TopNavBar = ({ menuItems, position, hasDownloadButton }) => {
  ...
  "inset-x-0 top-0 z-[60] w-full border-transparent bg-transparent transition-all duration-300 lg:bg-transparent [&.nav-sticky]:bg-transparent [&.nav-sticky]:shadow-none [&.nav-sticky]:backdrop-blur-none dark:[&.nav-sticky]:bg-transparent"
                ...
                {menuItems.map((item, idx) => {
                  return (
                    <li
                      key={idx}
                      className={cn(
                        "menu-item mx-2 text-white transition-all duration-300 hover:text-[#28A76D] s [&.active]:text-[#28A76D] ",
                        ...
                        {landingPages.map((item, idx) => {
                          return (
                            <li key={idx}>
                              <Link
                                className={cn(
                                  "flex items-center rounded px-3 py-2 text-sm font-medium text-white transition-all hover:bg-default-400/10 hover:text-default-700 [&.active]:text-[#28A76D] ",
      ...
      >
        ...
        <div className="h-[calc(100%-4rem)] overflow-y-auto text-white">
          <nav className="hs-accordion-group flex h-full w-full flex-col flex-wrap p-4">
            <ul className="space-y-1">
              ...
              <li className="hs-accordion" id="landing-accordion">
                {/* <Link
                  className="hs-accordion-toggle flex items-center rounded px-4 py-2.5 text-sm font-medium capitalize text-default-900 transition-all duration-300 hover:bg-default-100 hover:text-[#28A76D]  hs-accordion-active:bg-default-400/10 [&.active]:bg-default-100 [&.active]:text-[#28A76D] "
                  href=""
                >
                  Landing
